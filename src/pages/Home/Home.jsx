        ...
        <div className='h-screen bg-[#ebf1f3] p-6 flex md:justify-center md:items-center '>
            <div className='grid grid-cols-1 shadow-lg md:grid-cols-2  rounded-lg overflow-hidden '>
                ...
                <div className='p-5 flex flex-col  justify-center items-center bg-[#c7e2ee93]'>
                    ...
                    <h1 className='text-2xl md:text-3xl text-center font-bold text-gray-700'>WELCOME TO MBA Connect</h1>
                    <p className=' text-sm md:text-base mt-3 font-medium text-center  text-gray-500'>Stay connected with MBA Connect! Experience seamless video and audio calling, real-time chat, and hassle-free file sharing all in one app. Elevate your communication, anytime, anywhere.</p>
                </div>
            </div>
        </div>
    )
